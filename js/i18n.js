...
const I18N = {
  /* ---------------- SUOMI ---------------- */
    ...
    ui: {
      ...
      qrTitle: "Avaa puhelimella",
      qrSub: "Skannaa QR-koodi niin pääset suoraan tälle sivulle.",
      comingSoon: "Tulossa",
  ...
  en: {
    ui: {
      ...
      qrSub: "Scan the QR code to jump straight to this site.",
  ...
  sv: {
    ui: {
      ...
      qrTitle: "Öppna i telefonen",
      qrSub: "Skanna QR-koden för att komma direkt till den här sidan.",
